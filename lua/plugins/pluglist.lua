...
local plugins = {
...

	{
		"rose-pine/neovim",
		opts = function()
			return require("plugins.configs.colorschemes").rose_pine
		end,
		config = function(_, opts)
...

	{
		...
		opts = function()
			return require("plugins.configs.colorschemes").tokyonight
		end,
		config = function(_, opts)
...

	{
		"catppuccin/nvim",
		opts = function()
			return require("plugins.configs.colorschemes").catppuccin
		end,
		config = function(_, opts)
	...
	-- [[Jump arround]]
	{
		...
		ft = "*",
		opts = function()
			return require("plugins.configs.hop").opts
		end,
		config = function(_, opts)
